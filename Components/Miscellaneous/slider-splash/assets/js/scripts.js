...
function browse(dir) {
 rollInfo(dir);
  ...
  if(dir == "next") {
    if((document.querySelector('#belt div:nth-child(1)').getAttribute('class').split(' ').pop() != 'award') && (document.querySelector('#belt div:nth-child(2)').getAttribute('class').split(' ').pop() != 'award') &&
    (document.querySelector('#belt div:nth-child(3)').getAttribute('class').split(' ').pop() != 'award') && (document.querySelector('#belt div:nth-child(4)').getAttribute('class').split(' ').pop() != 'award')
    )
    {
      document.querySelector("#belt div:nth-child(1)").classList.remove(document.querySelector('#belt div:nth-child(1)').getAttribute('class').split(' ').pop()); // reset animation
      document.querySelector("#belt div:nth-child(2)").classList.remove(document.querySelector('#belt div:nth-child(2)').getAttribute('class').split(' ').pop()); // reset animation
      document.querySelector("#belt div:nth-child(3)").classList.remove(document.querySelector('#belt div:nth-child(3)').getAttribute('class').split(' ').pop()); // reset animation
      document.querySelector("#belt div:nth-child(4)").classList.remove(document.querySelector('#belt div:nth-child(4)').getAttribute('class').split(' ').pop()); // reset animation
    }
